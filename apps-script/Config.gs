var LMS = {
  APP_NAME: 'Edu Curicula',
  VERSION: '1.0.0-edu-curicula',
  TIMEZONE: Session.getScriptTimeZone() || 'Asia/Jakarta',
  MAX_UPLOAD_BYTES: 3 * 1024 * 1024,
  SHEETS: {
    SETTINGS:'SETTINGS', USERS:'USERS', WEEKS:'WEEKS', MATERIALS:'MATERIALS', ACTIVITIES:'ACTIVITIES',
    DISCUSSIONS:'DISCUSSIONS', POSTS:'POSTS', COMMENTS:'COMMENTS', SUBMISSIONS:'SUBMISSIONS', GRADES:'GRADES',
    RUBRICS:'RUBRICS', RUBRIC_SCORES:'RUBRIC_SCORES', QUIZZES:'QUIZZES', QUIZ_QUESTIONS:'QUIZ_QUESTIONS', QUIZ_ATTEMPTS:'QUIZ_ATTEMPTS',
    GROUPS:'GROUPS', GROUP_MEMBERS:'GROUP_MEMBERS', PROJECT_PLANS:'PROJECT_PLANS', ANNOUNCEMENTS:'ANNOUNCEMENTS', ACTIVITY_LOG:'ACTIVITY_LOG'
  },
  FOLDERS: {SUBMISSIONS:'01_Submissions',ASSETS:'02_Assets',EXPORTS:'03_Exports',TEMP:'99_Temp'}
};
var SCHEMA = {
  ...
  GROUPS:['group_id','project_code','name','meeting_no','topic','created_at','updated_at'],
...
var DEFAULT_SETTINGS = {
  ...
  COURSE_NAME:'Kurikulum dan Tren Pendidikan Fisika',
  COURSE_WEEKS:'16',
...
// Compatibility guards untuk endpoint legacy. Edu Curicula
// tidak menggunakan bank kuis/diskusi statis, tetapi service lama masih
// menyediakan endpoint kompatibilitas. Definisi kosong ini mencegah ReferenceError.
var STATIC_QUIZ_BANK = {};
var STATIC_DISCUSSION_BANK = {};
var STATIC_ACTIVITY_META = [];
