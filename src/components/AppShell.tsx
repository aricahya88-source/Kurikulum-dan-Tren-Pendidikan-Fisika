...
export default function AppShell({children,title='Edu Curicula'}:{children:React.ReactNode;title?:string}) {
  ...
  return <div className="app-bg">
    ...
    <aside className="desktop-sidebar glass-panel">
      <div className="brand">
        <img className="brand-logo-image" src="/icon-192.png" alt="Logo Edu Curicula"/>
        <div><strong>Edu Curicula</strong><small>Kurikulum & Tren Fisika • OBE</small></div>
      </div>
    ...
    <div className="app-stage">
      <header className="topbar glass-panel">
        <div>
          <span className="eyebrow">KURIKULUM & TREN PENDIDIKAN FISIKA • OBE</span>
          <h1>{title}</h1>
        </div>
